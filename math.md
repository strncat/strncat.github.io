...
<!------------------------------------------------------------------->  
  ...
  <ul style="list-style-type:none;">
	...
	<!--
    <li><a href="/jekyll/update/2024/05/04/analysis-set-least-upper-bound.html">
          (4) Given a set \(A\) bounded above in \(\mathbf{R}\) and a constant \(c\). The set defined as \(c+A\) has a least upper bound \(sup(c+A) = c + sup A\).
    </a></li>
	-->
  </ul>
<br>
