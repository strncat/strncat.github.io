...
Now, use <a href="http://aleph0.clarku.edu/~djoyce/java/elements/bookI/post2.html">postulate 2</a> to draw two finite lines from points $A$ and $B$ that end at points $E$ and $F$ respectively. 
<p style="text-align:center;"><img src="{{ site.url }}/assets/math/euclid/pr2/4.png" width="40%" class="center"></p>
