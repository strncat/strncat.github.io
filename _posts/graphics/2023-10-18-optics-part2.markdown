...
Light comes from all visible objects. One example is a shiny red car. Even though we don't have a red light source, we can still see the effect on the objects next to the car for example (some redish color). This is the affect of <b>color bleeding</b>.
<br>
<br>
