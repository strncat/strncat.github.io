...
(3) Run DFS again in the reverse graph from the node with the largest finishing time.
...
<br>
<b>3 Example</b><br>
<img src="{{ site.url }}/assets/scc/1.png" width="100%">
...
<img src="{{ site.url }}/assets/scc/2.png" width="100%">
