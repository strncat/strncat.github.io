...
So angles $\DBE$ and $EBC$ are equal to the three angles $\angle DBA$, $\angle ABE$ and $\angle EBC$. Similarly, the angle $\angle ABC$ is equal to the angles $\angle ABE$ and $\angle EBC$. Let the angle $\angle DBA$ be added to each.
