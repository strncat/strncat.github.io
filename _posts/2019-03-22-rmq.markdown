---
layout: post
title:  "The RMQ Problem"
date:   2019-03-22 07:01:36 -0700
categories: jekyll update
mathjax: true
---

![my photo]({{ site.url }}/assets/rmq-array.png)
...
<hr>
<br>
<b>3.1 Algorithm 1: Do nothing! $$\langle p(n), q(n)\rangle = \langle O(1), O(n)\rangle$$</b>
<br>
...
<hr>
<br>
<b>3.2 Algorithm 2: Compute all ranges $$\langle p(n), q(n)\rangle = \langle O(n^3), O(1)\rangle$$</b>
<br>
We compute the minimum element for all possible ranges. There are $$O(n^2)$$ possible ranges. We need $O(n)$ time to compute the minimum in each range so the total time preprocessing time is $$p(n) = O(n^3)$$.
<br>
<br>
<!------------------------------------------------------------------------------------>
<hr>
<br>
<b>3.3 Algorithm 3: Compute all ranges with DP $$\langle p(n), q(n)\rangle = \langle O(n^2), O(1)\rangle$$</b>
<br>
...
<hr>
<br>
<b>3.4 Algorithm 4: Block Decomposition, $$\langle p(n), q(n)\rangle = \langle O(n), O(\sqrt{n})\rangle$$</b><br>

![my photo]({{ site.url }}/assets/rmq-block.png)
...
<hr>
<br>
<b>3.5 Algorithm 5: Sparse Tables, $$\langle p(n), q(n)\rangle = \langle O(n\log(n)), O(1)\rangle$$</b><br>

![my photo]({{ site.url }}/assets/rmq-sparse-main.png)
...
![my photo]({{ site.url }}/assets/rmq-sparse.png)
...
<br>
![my photo]({{ site.url }}/assets/rmq-sparse-range.png)
<br>
...
![my photo]({{ site.url }}/assets/rmq-sparse-query.png)
<br>
Given indices $$i$$ and $$j$$:<br>
