...
The problem here is that the argument products of primes of the from $$4m+3$$ isn't necessarily of the form $$4m+3$$ so we need another argument. We need to use the fact that if a prime divides $$m^2 + 1$$, then $$p = 2$$ or $$p = 4n+1$$. 

<!-------------------------------------------------------------------------->
<hr>
<h3>References</h3>
<ul>
<li><a href="https://www.youtube.com/watch?v=VRrP4US7idg">Math115a by Richard E Borcherds</a></li>
</ul>
