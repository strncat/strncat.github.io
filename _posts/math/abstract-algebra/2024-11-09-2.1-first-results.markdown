...
<br>
<br>
What about $$S_2$$? The set is $$\{1,2\}$$. We have an identity map $$e$$. We also have the map that takes 1 to 2 and 2 to 1. Let this permutation be $$\tau$$. So $$S_2 = \{e, \tau\}$$. Note here that composing $$\tau tau = e$$. So $$\tau^{-1} = \tau$$. Side note here: When a permutation only changes two elements, it is called a transposition. 
...
are defined since we have at most $$n-1$$ elements. 
